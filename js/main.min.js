const header = document.querySelector(".header"),
  ...
  navbarToggleButton = document.querySelector(".navbar-toggle"),
  navbarDropdown = document.querySelector(".navbar-dropdown"),
  navbarLinks = document.querySelectorAll(".nav-link"),
  navList = document.querySelector(".navbar-list"),
  isNotMobile = window.matchMedia("(min-width: 768px)");
  ...
  window.addEventListener("resize", function () {
    window.innerWidth < window.innerHeight && !isNotMobile.matches
      ? ((navbarDropdown.style.backgroundColor = "#fff"),
        navbarLinks.forEach(
          (link) => (link.style.color = "rgba(0, 0, 0, 0.5)")
        ))
      : window.scrollY < 300 &&
